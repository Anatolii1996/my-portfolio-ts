      ...
      <ul>
        ...
        <li>
          ...
          <div className="technical__label">
            ...
            <h3>TypeScript</h3>
            <p>Під час роботи над даним проєктом, відбулось моє перше знайомство з цією мовою. Тому хто з Вас буде дивитись мій код, не судіть строго). В цілому мої враження від використання TS позитивні.</p>
