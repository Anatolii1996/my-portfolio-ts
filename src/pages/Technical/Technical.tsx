    ...
    <div className={pageAnimStyle}>
      ...
      <ul>
        ...
        <li>
          ...
          <ul>
            <li>
              ...
              <p>
                ...
                усього світу, спонукають мене до думки, що так і є. Ну що ж.
                Обіцяю, що наступний проєкт буде створений на Vite!
              </p>
              <p>
            ...
            <li>
              ...
              <p>
                ...
                все. Плюс react-redux має чудову зрозумілу документацію, тому не
                думаю, що найближчим часом пересяду на щось інше, хоча останнім
                часом ледь не на кожному профільному ресурсі зустрічаю
                інформацію про те, що є інший state-менеджер який швидший,
                кращий і скоро вб'є redux. Не думаю, що це так! Якщо я неправий
                переконайте мене в іншому.
              </p>
              <p>
                ...
                сторінка з'являється зправа і навпаки. Для цього я записав
                порядковий номер кожної сторінки в її локальний state, при
                покиданні сторінки (componentDidUnmount) записую цей номер в
                redux. На наступній сторінці є логіка, яка порівнює поточний
                локальний state та запис в redux, та відображає сторінку зліва
                чи зправа. В мене з'явилась дана ідея і я придумав такий спосіб
            ...
            <li>
              ...
              {/* <p>
            Трохи про Sass, та чому його тут не має. До цього проєкту,
            початок нової роботи в мене виглядав так:</p>
            <ol>
          ...
          <p>
            Переваги які давав мені Sass порівняно зі звичайним CSS:</p>
            <ol>
              <li>
          ...
          <p>
            ...
            тому на початку вивчення програмування я вважав, що ця
            технологія досить потрібна, адже код стає лаконічнішим, а процес
            розробки виглядає крутіше.
          </p>
          <p>
            То чому ж я вирішив відмовитись від Sass? Так тому, що в
            останніх оновленнях CSS з'явилися всі основні фішки, за які ми
            любили Saas. Змінні в CSS були вже давно. Міксіни я
            використовував, в основному, для завдання стилів шрифтам (в
            якомусь іншому випадку, не дуже скорочувалась кількість коду,
            адже повторюваність не така велика), зараз додалася CSS
            властивість "font", куди можна перерахувати всі властивості
            шрифта - той же міксін, той же 1 рядок коду. Вкладені селектори
            замінив CSS nesting.
          </p>
          <p>
            Розумію, що вказані моменти, це не єдине, що нам пропонував
            Sass. Наприклад була можливість прямо в файлі .scss прописувати
            цикли для стилів - але на мою думку, це дуже специфічний кейс.
            Можливість використання умов if/else, я це роблю в коді
            компоненту, а бібліотека Classnames дозволяє це робити зручно і
            супер-зрозуміло.
          </p>
          <p>
            Отже я прийшов до висновку, що в цьому проєкті мені Sass не
            потрібен, бо всі проблеми які він вирішував, можна вирішити і
            без нього.{" "}
          </p>
          <p>
            Не хочу, щоб у мого відвідувача склалося враження ніби я палкий
            противник бібліотеки Sass. Це зовсім не так. Якщо під час своєї
            роботи я зайду в глухий кут і щоб вийти з нього треба буде взяти
            цю бібліотеку, то я так і зроблю. Але тягнути в проєкт
            непотрібну технологію заради технології - не буду.
          </p>
          <p>
            Потенційного роботодавця хочу запевнити в тому, що при
            необхідності роботи з Sass, з моєї сторони питань не виникне. А
            стосовно вакансій, так там ще досі просять jQuery =)
          </p> */}
            </li>
            <li>
              <h3>Animate.css</h3>
        ...
        <li>
          ...
          <p>
            ...
            людей. Одночасна робота багатбох люде над різними частинами кодової
