  ...
  return (
    <div className={pageAnimStyle}>
      {language === "ua" ? (
        ...
        <>
        <p>
        This section will be of interest to both a developer who accidentally stumbled upon this resource and a potential employer who wants to understand what technologies I, as a candidate, have.
          </p>
          <p>
          This project became a kind of testing ground for me, where I honed my skills as a developer. I used many technologies and libraries for the first time, which required some time to master and study the documentation.
          </p>
          <p>
            Найсуттєвішою такою технологією став TypeScript. Власне проєкт був
            заново переписаний на TypeScript коли вже було створено близько 30%
      ...
      <ul>
        ...
        <li>
          ...
          <p>
            Під час роботи над даним проєктом, відбулось моє перше знайомство з
            цією мовою. Тому хто з Вас буде дивитись мій код, не судіть строго).
          </p>
          <p>В цілому мої враження від використання TS позитивні.</p>
          <p>
            Як було сказано вище, починав писати проєкт я на JS. Потім вирішив
            переписати та продовжувати роботу на TS, причин тому декілька:
          </p>
          <ol>
            <li>
              По-перше у вакансіях всі хочуть знання TS, а ринок праці сильніше
              за все диктує розробникам які технології вчити
            </li>
            <li>
              По-друге ця мова зараз стрімко набирає популярність, а в Європі це
              чи не найпопулярніша мова програмування
            </li>
            <li>
              По-третє знання TS дозволяє опановувати інші фреймворки такі як
              Angular. І хоча я зараз не планую вчити Angular, все ж в
        ...
        <li>
          ...
          <p>
            Тут Ви знайдете всю кодову базу даного проєкту, окрім IP адрес моїх
            пристороїв, які я використовую для ідентифікації себе на ресурсі.
            Розумію, що даний спосіб можливо не найкращий. Хотів би дізнатися
            Вашу думку, як краще можна це зробити. Також, якщо в когось із
            розробників виникнуть ідєї з покращення якості коду, дуже хочу їх
            почути!
          </p>
          <div className="technical__label">
        ...
        <li>
          ...
          <p>
            Також, під час завантаження додатку, в стор записую всю необхіжну
            інформацію з бази даних, що підвищує швидкість роботи додатку.
          </p>
        </li>
        <li>
          <div className="technical__label">
          ...
          <p>
            ...
            функціях-генераторах, що є нетривіальним розділом JavaScript, тому
            потребує трохи часу на вивчення. Зате зрозумівши як це працює, я
            отримав зручний спосіб керування асинхронним кодом. Логіка
            асинхронних викликів стала лаконічною та зрозумілою.
          </p>
          <p>
            Знаю, що зараз такий спосіб керування асинхронним кодом є
            застарілим, адже після появи reduxjs/toolkit всі перейшли на RTK
            Query. Я також дивився в цю сторону, з використанням RTK Query коду
            стає менше, але на мою думку код не такий зрозумілий і не так тонко
            можна керувати асинхронними викликами. Загалом Redux-Saga мені дуже
            подобається.
          </p>
          <p>
            А в який спосіб Ви керуєте асинхронним кодом? Невже Redux-Saga вже є
            безнадійно застарілим?
          </p>
        </li>
        <li>
          <div className="technical__label">
        ...
        <li>
          ...
          <p>
            Тут Ви знайдете всю кодову базу даного проєкту, ключів до бази
            даних. Аналогічно, в разі виникнення ідєй з покращення якості коду,
            прошу зі мною поділитись.{" "}
          </p>
          <div className="technical__label">
          ...
          <p>
            ...
            раніше записані, а також обробка повідомлень в чаті. Дуже цікава та
            функціональна технологія. Розумію, що вивчати тут мені ще доведеться
            дуже багато, але обов'язково буду цим займатись. В якості Node.js
            фреймворку взято Express через його простоту та популярність. Код
            дуже схожий на звичайний Node.js, тому період звикання мінімальний.
            В майбутньому все ж планую перейти на Nest. Хто пише backend, що про
            це думаєте?
          </p>
        </li>
        <li>
          ...
          <p>
            ...
            NoSQL база даних. Має можливість працювати з даними локально або в
            хмарі. Має розвинену підтримку та багато зрозумілої документації.
            Має можливість задання строгої типізації для даних в колекціях, без
            TypeScript, що дозволяє зробити взаємодію з БД стабільною, та
            уникнути зайвих помилок. Як на мене то типізація працює не настільки
            круто як в TS, але така можливість все одно крута. Firebase мені не
            настільки сподобався. В майбутньому буду вважати основною БД, якщо
            не буде інших вимог. А якими базами даних користуєтесь Ви?
          </p>
        </li>
        ...
        <li>
          ...
          <p>
            На даний момент досить поверхнево знайомий з даною бібліотекою, та і
            з процесом написання тестів в цілому. Після розгоротання даного
            проєкту на хостингу буду поглиблено вивчати дану тему. Для більшої
            продуктивності праці буду шукати собі тестувальника, тому якщо хтось
            із починаючих тестувальників хочу приєднатись, зв'яжіться зі мною.
            Краще через особисті інстаграмму або на вайбер за номером телефону.
          </p>
        </li>
        <li>
          <div className="technical__label">
          ...
          <p>
            Дуже функціональний безкоштовний хостинг. Має великий функціонал,
            розгортає проєкти прямо з репозиторію на льоту, може хостити backend
            додатки. Для початківця - те що треба. Для комерційної роботи не
            взяв би через ціну. Цікаво, який хостинг Ви вважаєте найкращим?
          </p>
        </li>
      </ul>
    </div>
