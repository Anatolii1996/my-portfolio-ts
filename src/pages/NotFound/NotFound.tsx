...
const NotFound = () => {
  ...
  const yetiRef = useRef();
  const ligthRef = useRef();

  // useLayoutEffect(() => {
  //   // Функция для переключения между светлым и темным режимами
  //   const goDark = () => {
  ...
  //     // Создаем анимацию Chatter
  //     const chatterTimeline = gsap.timeline({
  //       paused: true,
  //       repeat: -1,
  //       yoyo: true,
  //     });
  ...
  //       "0"
  //     );
  //     // Добавьте другие анимации Chatter, если они есть

  //     // Создаем анимацию Yeti
  //     const yetiTimeline = gsap.timeline({
  //       paused: true,
  //       repeat: -1,
  //       repeatDelay: 0,
  //       delay: 0,
  ...
  //     }, "0");
  //     // Добавьте другие анимации Yeti, как в вашем оригинальном коде

  //     // Запускаем анимации
  //     goDark(); // Инициализация в темном режиме
  //     chatterTimeline.pause(); // Приостанавливаем анимацию Chatter, чтобы она не начиналась сразу

  //     ligthRef.current = chatterTimeline;
  //     yetiRef.current = yetiTimeline;

  //     yetiTimeline.play(); // Запускаем анимацию Yeti
  //   };
  ...
  return (
    <>
      ...
      <div className="content">
        ...
        <p>
          Сторінка не знайдена. Поверніться <NavLink to="/">на головну</NavLink>{" "}
          сторінку.
        </p>
      </div>
    </>
